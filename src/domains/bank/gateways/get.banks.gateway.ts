import { IBankRepository, IGetBanksGateway, GetBanksGatewayParams, GetBanksData, FindBankCriteria } from '../interfaces/';
import { BankEntity } from '../entities/bank.entity';
import { MixGetBanksService } from '../../../adapters/gateways/get.banks.gateway';

export class GetBanksGateway extends MixGetBanksService implements IGetBanksGateway {
