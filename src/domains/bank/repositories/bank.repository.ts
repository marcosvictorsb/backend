...
import { CreateBankCriteria, DeleteBankData, FindBankCriteria, IBankRepository, IBankRepositoryDependencies, UpdateBankData } from "../interfaces";
...
export class BankRepository implements IBankRepository {
  ...
  public async find(criteria: FindBankCriteria): Promise<BankEntity | undefined> {
