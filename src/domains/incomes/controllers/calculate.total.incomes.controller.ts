...
import { CalculateTotalIncomesControllerParams, InputCalculateTotalIncomes } from '../interfaces/';

interface ICalculateTotalIncomesController {
  calculateTotalIncomes(request: Request, response: Response): Promise<Response>;
}

export class CalculateTotalIncomesController implements ICalculateTotalIncomesController {
  ...
  public async calculateTotalIncomes(request: Request, response: Response): Promise<Response> {
