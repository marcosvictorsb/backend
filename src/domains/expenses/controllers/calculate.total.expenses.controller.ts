...
import { CalculateTotalExpensesControllerParams, InputCalculateTotalExpenses } from '../interfaces/';

interface ICalculateTotalExpensesController {
  calculateTotalExpenses(request: Request, response: Response): Promise<Response>;
}

export class CalculateTotalExpensesController implements ICalculateTotalExpensesController {
  ...
  public async calculateTotalExpenses(request: Request, response: Response): Promise<Response> {
