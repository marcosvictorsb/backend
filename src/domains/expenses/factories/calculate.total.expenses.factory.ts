...
const interactor = new CalculateTotalExpensesInteractor(calculateGateway, presenter);
export const calculateTotalExpensesController = new CalculateTotalExpensesController({ interactor });
