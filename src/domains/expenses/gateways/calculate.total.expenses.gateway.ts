import {
  ...
  CalculateTotalExpensesGatewayParams,
...
export class CalculateTotalExpensesGateway
  extends MixCalculateTotalExpensesService
  implements ICalculateTotalExpensesGateway
{
